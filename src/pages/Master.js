  ...
  return (
    <div>
      ...
      <div className="pbs text-center text-snow ">
        ...
        <p className="text-2xl mt-5 mb-7">weekly based classes just for You</p>
        <div className="flex flex-col justify-center" >
          <strong className = " text-3xl">Introduction</strong>
          <iframe src="https://youtube.com/embed/8WuV8Fr-NCg" className ="rounded-md self-center" title="Intro" width = '700' height = "315" frameBorder="0">INtro</iframe>
        </div>
        <div className="text-white bg-gray-900">
          <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
            <div className="max-w-lg mx-auto text-center">
              <h2 className="text-3xl font-bold sm:text-4xl">
                Kickstart your Classes
              </h2>
