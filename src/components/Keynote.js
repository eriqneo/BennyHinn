...
const Keynote = () => {
  return (
    ...
    <div className='key my-5 ml-14 grid grid-cols-1'>
            <div className='text-white text-center text-2xl mt-24 mb-24 sm:ml-4 sm:mr-3 md:ml-2'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
